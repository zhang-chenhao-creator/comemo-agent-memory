...
目标：在不影响质量的前提下，让你更高效地使用 agent 软件，并尽量降低长上下文带来的 token 成本。

适合谁：

- 跨项目使用 Codex、Claude Code、Cursor、Aider、Gemini CLI 等 coding agent 的人。
- 希望 AI 作为协作者，而不是把 AI 当作外接大脑替代自己思考的人。
- 担心长上下文让 agent 变慢、变贵、变不稳定的人。
- 想把记忆沉淀成规律，而不是堆成越来越厚的错题本或摘要库的人。
- 希望一套 Markdown 记忆能跨工具迁移、不被单一平台绑定的人。
